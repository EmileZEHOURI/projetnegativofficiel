      ...
      <Container className="flex flex-col h-full pl-[106px] pr-[106px] items-start  ">
        ...
        <div>
          ...
          >
            ...
            s’épanouir individuellement au sein de notre collectif. La formation
            est le fil rouge de notre club. Nous voulons former des joueurs, des
            éducateurs, des coachs, des arbitres et aussi des dirigeants.
          </Typography>
          <Typography
            variant="caption1"
            component="p"
            ...
            className="mt-14 w-[800px] leading-10"
          >
            Notre club possède une force qu’il puise dans sa diversité à l’image
            de notre arrondissement et des quartiers « Politique de la Ville »
            dans lesquels nous évoluons. Nous nous engageons et nous
            investissons dans de nombreuses actions au sein de notre quartier ou
            auprès de la Ville de Paris et souhaitons renforcer le maillage
        ...
        <div>
          ...
          >
            ...
            La formation est le fil rouge de notre club. Nous voulons former des
            ...
            École d’Arbitrage ou grâce à l’accès aux formations internes menant
            aux diplômes d’entraîneurs.
          </Typography>
          <Typography
            variant="caption1"
            component="p"
          ...
          >
            ...
            place des stages gratuits ou payants durant les vacances, du soutien
            scolaire, des sorties, des rencontres, débats, etc…
          </Typography>
